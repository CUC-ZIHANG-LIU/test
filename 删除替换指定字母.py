...
if __name__ == "__main__":
    input_file_path = 'D:\\文件\\其他\\TEST\\promeanv2a-video\\备份\\train-data.json'  # 输入文件路径
    output_file_path = 'D:\\文件\\其他\\TEST\\promeanv2a-video\\修改\\output-train-data.json'  # 输出文件路径
